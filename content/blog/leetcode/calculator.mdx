...
[[fig | Shunting-yard Algorithm trace for A + B * C - D]]
...
fun toRPN(s: String): List<Any> {
  ...
  var i = 0
  // The first char could be unary op.
...
This problem asks to implement the atoi function. The string to integer idiom is highlighted.
