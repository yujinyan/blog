...
date: 2021-02-11T15:49:03.285Z
issueId: 19
discussionId: 176
description: Kotlin 协程的 Context 和 Scope 与结构化并发
---
...
<figure>
  ...
  <figcaption> 重要 Context 的继承/实现关系 </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>`CombinedContext` 数据结构示意</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    黑盒性质：控制流流入 → [黑盒] → 控制流流出，复刻自 [njs blog](https://vorpus.org/blog/notes-on-structured-concurrency-or-go-statement-considered-harmful/).
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    结构化并发同样满足「黑盒」性质，复刻自 [njs blog](https://vorpus.org/blog/notes-on-structured-concurrency-or-go-statement-considered-harmful/).
  </figcaption>
</figure>
...
<KotlinSection class="mt-8" currentSlug="kotlin-coroutine-context-scope" />